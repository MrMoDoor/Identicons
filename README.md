...
****
 ...
 Second,when you need it,you can check it out and take it into this function,then,you can create the identicons.<br>
一个创建identicons的方法,你可以在你的网页或者窗体文件上使用本方法.<br>
使用本方法,,你可以很容易的创建你的identicons,我已经在WinForm,B/S,WPF分别添加了调用代码.<br>
